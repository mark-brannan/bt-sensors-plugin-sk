const Images = require('./VictronImages.js')
 ...
 const VC=
 {
  ...
  MeterType : new Map([
    [-9, {name:'SOLAR_CHARGER',  category:'solar'}],
    [-8, {name:'WIND_CHARGER', category:'chargers'} ],
    [-7, {name:'SHAFT_GENERATOR', category:'chargers'}],
    [-6, {name:'ALTERNATOR', category:'alternators'}],
    [-5, {name:'FUEL_CELL', category:'chargers'}],
    [-4, {name:'WATER_GENERATOR', category: 'chargers'}],
    [-3, {name:'DC_DC_CHARGER', category:'chargers'}],
    [-2, {name:'AC_CHARGER', category:'chargers'}],
    [-1, {name:'GENERIC_SOURCE', category:'chargers'}],
    [1, {name:'GENERIC_LOAD',category:'dcload'}],
    [2, {name:'ELECTRIC_DRIVE',category:'dcload'}],
    [3, {name:'FRIDGE',category:'dcload'}],
    [4, {name:'WATER_PUMP',category:'dcload'}],
    [5, {name:'BILGE_PUMP',category:'dcload'}],
    [6, {name:'DC_SYSTEM',category:'dcload'}],
    [7, {name:'INVERTER',category:'inverters'}],
    [8, {name:'WATER_HEATER',category:'dcload'}]
  ]),
  MODEL_ID_MAP : {
    0x1: "VPN",
    0x2: "VBC",
